...
const BOARD_COMPONENT_PRESETS: BoardComponentPreset[] = [
  ...
  },
  {
    ...
    label: 'Image',
    description: 'A framed image area for logos, faction crests, art callouts, or map details.',
    properties: {
      label: 'Image',
  ...
  },
  {
    ...
    description: 'A graph-style region for custom adjacencies and node-based movement.',
    properties: {
      label: 'Network',
      nodes: [
        { id: 'node_a', x: 0, y: 0, label: 'A' },
        { id: 'node_b', x: 1, y: 0, label: 'B' },
        { id: 'node_c', x: 0.5, y: 1, label: 'C' },
      ],
      edges: [
        ['node_a', 'node_b'],
        ['node_b', 'node_c'],
  ...
  },
  {
    ...
    componentType: 'card',
    label: 'Standard Card',
    description: 'A portrait card frame for decks, tableau cards, or board-attached references.',
    properties: {
      label: 'Card',
      title: 'Card Title',
      subtitle: 'Card text',
